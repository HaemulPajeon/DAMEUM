...
export default function BookTitleScreen({ navigation }) {
  const [title, setTitle] = useState('');

  const goToReading = (bookTitle) => {
    navigation.navigate('BookReading', { title: bookTitle || '제목 없는 동화책' });
  };
    ...
    <View style={styles.container}>
      ...
      <SafeAreaView style={styles.safe} edges={['top', 'bottom']}>
        <View style={styles.sheet}>
          ...
          <Text style={styles.heading}>동화책 제목을 작성해주세요.</Text>
          ...
          <View style={styles.btnRow}>
            <TouchableOpacity style={styles.secondaryBtn} onPress={() => goToReading('')}>
              <Text style={styles.secondaryText}>다음에</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.primaryBtn} onPress={() => goToReading(title.trim())}>
